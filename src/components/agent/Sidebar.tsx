...
import { LayoutDashboard, FileText, Settings, Banknote, CreditCard } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const menuItems = [
    { name: 'Tableau de bord', href: '/agent/dashboard', icon: LayoutDashboard },
     { name: 'Clients', href: '/agent/clients', icon: FileText },
    { name: 'Cheques', href: '/agent/cheques', icon: CreditCard },
  ];
  return (
