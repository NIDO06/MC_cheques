...
import { LayoutDashboard, Building2, Users2, ShieldCheck, Banknote, Terminal } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: 'Agences', href: '/admin/agences', icon: Building2},
    { name: 'Platform-logs', href: '/admin/platform-logs', icon: Terminal },
  ];
  return (
    <aside className="w-[280px] bg-[#f8fafc] border-r border-gray-200 flex flex-col justify-between h-screen sticky top-0 shrink-0">
